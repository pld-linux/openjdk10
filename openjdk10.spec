...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk10-jdk < 10.0.2.13-3
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk10-jdk-base < 10.0.2.13-3
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk10-jre < 10.0.2.13-3
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk10-jre-base < 10.0.2.13-3
...
Obsoletes:	openjdk10-jre-base-X11 < 10.0.2.13-3
...
Group:		Development/Languages/Java
Requires:	%{name}-jre = %{version}-%{release}
Obsoletes:	openjdk10-jre-base-alsa < 10.0.2.13-3
...
Group:		Development/Languages/Java
Requires:	%{name}-jre = %{version}-%{release}
Obsoletes:	openjdk10-jre-base-freetype < 10.0.2.13-3
...
Obsoletes:	jar
Obsoletes:	openjdk10-jar < 10.0.2.13-3
...
Obsoletes:	openjdk10-appletviewer < 10.0.2.13-3
